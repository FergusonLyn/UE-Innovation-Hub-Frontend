...
const Lookingforwardto = () => {
  return (
    <>
       ...
       <div className="h-[1800px] md:h-[950px] flex flex-col items-center text-black">
         <div className='font-medium text-center text-3xl md:text-4xl m-7 text-gray-800'>What you can look forward to<span className='text-red-500'>.</span></div>
          <div className='w-full md:w-9/12 h-5/6 grid grid-cols-1 md:grid-cols-2 m-1 md:mx-5 mb-4'>

          {/* first half div on the left */}
              <div className='h-full w-full md:w-[480px] grid grid-rows-3 p-1 md:p-4'>
                {/* first div */}
                <div className='row-span-1 w-full mb-3 grid grid-cols-4 '>
                  <div className='col-span-1 relative items-center p-6'>
                    <div className='bg-green-300 rounded-full h-8 w-8 md:h-10 md:w-10 absolute top-4 md:top-3 right-2 md:right-5'></div>
                    <span className='font-extrabold text-5xl relative z-10'>
                      <RiBriefcase4Line className='text-gray-800 font-extrabold' />
                    </span>                    
                  </div>
                  <div className='col-span-3 p-6'>
                    <div className='text-gray-800 font-semibold text-xl md:text-2xl mb-2'>Find a job</div>
                ...
                <div className='row-span-1 w-full mb-3 grid grid-cols-4 '>
                  <div className='col-span-1 relative items-center p-6'>
                    <div className='bg-violet-400 rounded-full h-8 w-8 md:h-10 md:w-10 absolute top-4 md:top-3 right-2 md:right-5'></div>
                    <span className='font-extrabold text-5xl relative z-10'>
                      <MdOutline4K className='text-gray-800 font-extrabold' />
                    </span>                    
                  </div>
                  <div className='col-span-3 p-6'>
                    <div className='text-gray-800 font-semibold text-xl md:text-2xl mb-2'>Use the latest equipment</div>
                ...
                <div className='row-span-1 w-full mb-3 grid grid-cols-4 '>
                  <div className='col-span-1 relative items-center p-6'>
                    <div className='bg-orange-300 rounded-full h-8 w-8 md:h-10 md:w-10 absolute top-4 md:top-3 right-2 md:right-5'></div>
                    <span className='font-extrabold text-5xl relative z-10'>
                      <PiLightbulbFilamentBold className='text-gray-800 font-extrabold' />
                    </span>                    
                  </div>
                  <div className='col-span-3 p-6'>
                    <div className='text-gray-800 font-semibold text-xl md:text-2xl mb-2'>Enter the Berlin start up scene</div>
              ...
              <div className='h-full w-full md:w-[480px] grid grid-rows-3 p-1 md:p-4'>
                ...
                <div className='row-span-1 w-full mb-3 grid grid-cols-4 '>
                  <div className='col-span-1 relative items-center p-6'>
                    <div className='bg-amber-300 rounded-full h-8 w-8 md:h-10 md:w-10 absolute top-4 md:top-3 right-2 md:right-6'></div>
                    <span className='font-extrabold text-5xl relative z-10'>
                      <BiConversation className='text-gray-800 font-extrabold' />
                    </span>                    
                  </div>
                  <div className='col-span-3 p-6'>
                    <div className='text-gray-800 font-semibold text-xl md:text-2xl mb-2'>Opportunity to learn German</div>
                ...
                <div className='row-span-1 w-full mb-3 grid grid-cols-4 '>
                  <div className='col-span-1 relative items-center p-6'>
                    <div className='bg-pink-400 rounded-full h-8 w-8 md:h-10 md:w-10 absolute top-4 md:top-3 right-2 md:right-6'></div>
                    <span className='font-extrabold text-5xl relative z-10'>
                      <BiTaxi className='text-gray-800 font-extrabold' />
                    </span>                    
                  </div>
                  <div className='col-span-3 p-6'>
                    <div className='text-gray-800 font-semibold text-xl md:text-2xl mb-2'>Excursions & field trips</div>
                ...
                <div className='row-span-1 w-full mb-3 grid grid-cols-4 '>
                  <div className='col-span-1 relative items-center p-6'>
                    <div className='bg-blue-300 rounded-full h-8 w-8 md:h-10 md:w-10 absolute top-4 md:top-3 right-2 md:right-6'></div>
                    <span className='font-extrabold text-5xl relative z-10'>
                      <PiArrowsSplitBold className='text-gray-800 font-extrabold transform scale-y-[-1]' />
                    </span>                    
                  </div>
                  <div className='col-span-3 p-6'>
                    <div className='text-gray-800 font-semibold text-xl md:text-2xl mb-2'>Internships & practical projects</div>
