...
const DegreeDiv = () => {
  return (
    <>
      ...
      <div className="h-[1400px] md:h-[630px] flex flex-col items-center text-black bg-red-50 mb-[50px]">
        <div className="font-medium text-center text-4xl mt-8 mb-10 text-gray-800">
          Your degree in a nutshell<span className="text-red-500">.</span>
        </div>
        
        <div className="w-full md:w-9/12 h-5/6 grid grid-cols-1 md:grid-cols-2 gap-8 p-2 md:p-6 m-1 md:mx-5 mb-4">
          <div className="p-2 md:p-0 h-full w-full flex justify-between"> {/* Flex layout with space between */}
            ...
            <div className="w-[48%]">
              <ul className="p-1 md:p-0 space-y-8"> {/* Same spacing between items */}
                <li>
                  <span className="text-base md:text-xl text-gray-600">Master of Science (M.Sc.)</span>
                </li>
                <li>
                  <span className="text-base md:text-xl text-gray-600">State Accreditation</span>
                </li>
                <li>
                  <span className="text-base md:text-xl text-gray-600">1, 1.5 or 2 years</span>
                </li>
                <li>
                  <span className="text-base md:text-xl text-gray-600">UE Innovation Hub <br /> (near Berlin)</span>
                </li>
                <li>
                  <span className="text-base md:text-xl text-gray-600">March or September</span>
                </li>
                <li>
                  <span className="text-base md:text-xl text-gray-600">English</span>
                </li>
                <li>
                  <span className="text-base md:text-xl text-gray-600">EU from €854/month <br />Non-EU from €12,000/year</span>
                </li>
              </ul>
            </div>
          </div>
