...
const Footer = () => {
  return (
    <>
        <div className="w-full md:h-[370px] h-auto bg-teal-900 flex items-center justify-center">
            <div className='grid grid-cols-1 md:grid-cols-2 w-4/5 md:h-[260px] h-auto '>
